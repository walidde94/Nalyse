    ...
    useEffect(() => {
        const initAuth = async () => {
            ...
            if (storedToken && storedUser) {
                ...
                setIsLoading(false); // Stop blocking UI immediately with cached data
                ...
                try {
                    ...
                    console.error('Auth initialization error (likely offline):', error);
                    // Don't force logout on general network error so offline mode still works
                }
            } else {
                setIsLoading(false);
            }
