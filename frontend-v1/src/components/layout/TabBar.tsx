...
import {
    ...
    ArrowRightFromLine, ArrowLeftFromLine, Files, BarChart3, Bot, Sparkles, Network, GitCompareArrows, Activity, ShieldAlert, Landmark, FlaskConical, Workflow, Server, Smartphone
} from 'lucide-react';
...
export interface TabType {
    id: string;
    title: string;
    type: 'dashboard' | 'analysis' | 'settings' | 'landing' | 'bi' | 'correlate' | 'migration' | 'nexus' | 'groups' | 'projects' | 'developer' | 'sources' | 'logistics' | 'agentic' | 'democracy' | 'multi-analysis' | 'diff' | 'anomaly' | 'financial' | 'simulation' | 'automation' | 'admin' | 'mobile' | 'synthesis';
    data?: any;
...
export const TabBar = ({
    ...
    const getTabIcon = (tab: TabType) => {
        ...
        const iconMap: Record<string, React.ReactNode> = {
            ...
            'automation': <Workflow size={13} />,
            'admin': <Server size={13} />,
            'mobile': <Smartphone size={13} />,
            'synthesis': <Activity size={13} />,
        };
                ...
                {tabs.map((tab, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <MagneticHover intensity={0.15} className="flex flex-1 items-center gap-2 overflow-hidden">
                                <span style={{
                                    display: 'flex',
                                    alignItems: 'center',
