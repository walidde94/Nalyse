    ...
    const NAV_GROUPS = [
        {
            ...
            items: [
                ...
                { id: 'automation', label: 'Automation Hub', icon: <Workflow size={19} /> },
            ]
        },
        {
            ...
            items: [
                ...
                { id: 'synthesis', label: 'Data Synthesis', icon: <Activity size={19} /> },
                { id: 'financial', label: 'Financial Risk', icon: <Landmark size={19} /> },
                { id: 'admin', label: 'Platform Analytics', icon: <ServerCog size={19} /> },
            ]
        },
        {
    ...
    return (
        ...
        >
            ...
            <nav style={{
                ...
                <NavItem id="mobile" label="Mobile Settings" icon={<Smartphone size={19} />}
                    isActive={currentView === 'mobile'} collapsed={collapsed}
                    hovered={hoveredItem === 'mobile'} onHover={setHoveredItem}
