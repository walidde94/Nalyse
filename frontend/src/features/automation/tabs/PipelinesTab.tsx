                        ...
                        {wizardStep === 3 && (
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                                ...
                                <div><div style={L}>Channel</div><div style={{ display: 'flex', gap: 8 }}>
                                    <button onClick={() => setForm({...form, deliveryChannel: 'email'})} style={{ flex: 1, padding: 12, borderRadius: 12, background: form.deliveryChannel === 'email' ? '#6366f1' : 'rgba(255,255,255,0.05)', border: 'none', color: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6, justifyContent: 'center', fontSize: 12, fontWeight: 700 }}><Mail size={14} /> Email</button>
                                    <button onClick={() => setForm({...form, deliveryChannel: 'webhook'})} style={{ flex: 1, padding: 12, borderRadius: 12, background: form.deliveryChannel === 'webhook' ? '#10b981' : 'rgba(255,255,255,0.05)', border: 'none', color: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6, justifyContent: 'center', fontSize: 12, fontWeight: 700 }}><Globe size={14} /> Webhook</button>
                                </div></div>
