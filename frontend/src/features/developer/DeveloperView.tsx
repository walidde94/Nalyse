            ...
            endpoints: [
                {
                    ...
                    desc: 'Upload a new dataset (CSV/JSON) via multipart form-data.',
                ...
                },
                {
                    ...
                    desc: 'Retrieve metadata and current processing status for a specific dataset.',
                    payload: 'None',
            ...
            endpoints: [
                {
                    ...
                    curl: `curl -X POST ${API_URL}/api/v1/charts \\\n  -H "X-API-KEY: ${keys[0]?.key || 'YOUR_KEY'}" \\\n  -d '{"datasetId": "{id}", "type": "bar"}'`
                }
            ]
        }
    ];
